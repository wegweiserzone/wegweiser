...
// commits.
//
// The journal is not a log kept alongside the zones; it is the only way their
// data changes (architecture invariant 4). Four of the product's features read from
...
// docs/decisions/d19-journal-as-command-log.md.
//
